...
local library = {tabs = {}, draggable = true, flags = {}, title = 'claymore rewrite', open = false, mousestate = true, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = 'claymore_configs', fileext = '.clay'}
...
library.CreditSection:AddLabel('Danix#6637 ~ owner | lead dev');
library.CreditSection:AddLabel('Portal#4849 ~ rewrite dev');
